...
(1, 'Isyraf AIman', 'Kuala Lumpur', 'Manual Car', 'Booked'),
(5, 'Zakaria Amri', 'Penang', 'Manual Car', 'Booked'),
(7, 'Nur Imanina', 'Terengganu', 'Automatic Car', 'Booked'),
(8, 'Mawi Akmar', 'Terengganu', 'Motorcycle', 'Booked');
